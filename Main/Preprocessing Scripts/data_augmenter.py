...
path = 'C:\\GitHub\\mmWave-HAR\\Main\\Shared Resources\\reduced_data.csv' # Path to the csv file with all of the activity data.
...
with open('C:\\GitHub\\mmWave-HAR\\Main\\Shared Resources\\augmented_data.csv', 'w', newline='') as file:
