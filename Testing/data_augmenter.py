...
SAMPLE_LENGTH = 4 # Sample length in seconds.
IMAGE_PIXELS = 77 # Pixels in a single image.

path = 'C:\\Users\\Samuel Mason\\Documents\\GitHub\\mmWave-HAR\\Testing\\reduced_data.csv' # Path to the csv file with all of the activity data.
